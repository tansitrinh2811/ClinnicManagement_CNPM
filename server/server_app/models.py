...
if __name__ == '__main__':
    with app.app_context():
        ...
        quy_dinh_1 = QuyDinh(tenQuyDinh=' Mỗi ngày khám tối đa 40 bệnh nhân', moTa=' Mỗi ngày khám tối đa 40 bệnh nhân.',
                             quanTriVien_id=1)
        quy_dinh_2 = QuyDinh(tenQuyDinh=' Có 30 loại thuốc, 3 loại đơn vị (viên, chai, vỹ)', moTa=' Có 30 loại thuốc, 3 loại đơn vị (viên, chai, vỹ)',
                             quanTriVien_id=1)
        quy_dinh_3 = QuyDinh(tenQuyDinh='Tiền khám 100.000 VNĐ ', moTa='Tiền khám 100.000 VNĐ ', quanTriVien_id=1)
